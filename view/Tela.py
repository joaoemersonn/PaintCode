...
class Tela:
    def __init__(self, window, largura, altura):
        ...
        self.__janela2 = pygame.transform.smoothscale(self.__janela.convert_alpha(), (int(60* self.scala_x), int(60* self.scala_y)) )
        ...
        self.caixaTexto = InputBox(100*ESCALAX, 30, int(550*ESCALAX), int(300*ESCALAX))
        # INICIO
       ...
       # self.botaostart.definirPosicao((((largura/2)-self.botaostart.rect.h), 330))
        ...
        self.botaoVolume.definirPosicao(((self.largura-100), 50))
        # ESCOLHERSAVE
        ...
        self.savesPane=Painel(self.escalarX(943), self.escalarY(493), self.escalarX(25 + (self.ajuste / 2)), self.escalarY(70))
    ...
    def desenhar(self):
        ...
        if not self.desenhaNovoJogo and not self.desenhaAlerta and not self.desenhaConfirmacao:
            ...
            # TELA SAVES
                ...
                contornar(self.janela, int(ESCALAX*(25 + (self.ajuste / 2))), int(70*ESCALAY), int(ESCALAX*943), int(ESCALAY*493), 4)
    ...
    def desenharPainelSaves(self, jogador):
        ...
        for x in jogador:
            ...
            self.savesPane.blit(
                text3, (self.escalarX(710), self.escalarY((espaco * qntsaves) + 90 + self.rolagem)))
        ...
        if fases is not None:
            ...
            for fase in fases:
                ...
                pygame.gfxdraw.filled_trigon(self.janela,
                                             self.escalarX(intx + auxX + (espaco * qntdFase) + 265 + int((escala * desenho.colunas) / 2)),
                                            self.escalarY(inty + aux + 50),
                                            self.escalarX(intx + auxX + (espaco * qntdFase) + 260),
                                            self.escalarY(85 + inty + aux),
                                            self.escalarX(intx + auxX + (espaco * qntdFase) + 270 + escala * desenho.colunas),
